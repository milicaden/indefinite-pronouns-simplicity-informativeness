...
pareto <- data.frame(costoflanguages = seq(from = 0.8, to = 14.5, length.out = 10000))
...
png("Experiment1_pragmatic_complexlot.png", width = 140, height = 90, units='mm', res = 300)
p2 <- p1 + 
...
# Add Pareto front to the plot
png("Experiment2_pragmatic_complexlot.png", width = 140, height = 90, units='mm', res = 300)
p4 <- p3 + 
