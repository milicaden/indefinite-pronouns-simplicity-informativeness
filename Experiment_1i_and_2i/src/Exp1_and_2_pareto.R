...
png("Experiment1_literal_complexlot.png", width = 140, height = 90, units='mm', res = 300)
p2 <- p1 + 
...
# Add Pareto front to the plot
png("Experiment2_literal_complexlot.png", width = 140, height = 90, units='mm', res = 300)
p4 <- p3 + 
